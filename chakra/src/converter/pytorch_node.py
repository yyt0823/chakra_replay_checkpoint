...
class PyTorchNode:
    ...
    def is_checkpoint_op(self) -> bool:
        """
        Check if the node is a checkpoint operation.
        
        Returns:
            bool: True if the node is a checkpoint operation, False otherwise.
        """
        return ("CHECKPOINT" in self.name)
